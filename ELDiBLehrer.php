...
if ( isset($_GET['SetELDiBLehrer']) ){
    ...
    $sql = "SELECT * FROM eldibdatalehrer WHERE idClient = '".$_GET['SetELDiBLehrer']."'";
    ...
    $sqlHistory = "SELECT * FROM clienthistoryeldiblehrer WHERE idChild = '".$_GET['SetELDiBLehrer']."' ORDER BY `clienthistoryeldiblehrer`.`SaveTime` DESC";
    ...
    for($number = 1; $number < 183; $number ++){
      $sqlHistory2 = "SELECT * FROM clienthistoryeldiblehrer WHERE idChild = '".$_GET['SetELDiBLehrer']."' AND id = ".$ActId." ORDER BY `clienthistoryeldiblehrer`.`SaveTime` DESC";
  ...
  for($BereichID = 1; $BereichID <=4; $BereichID++)
    ...
    while ($zeile = mysqli_fetch_assoc( $db_erg))
      ...
      //$sqldata = "SELECT * FROM clienthistoryeldiblehrer WHERE idChild = '".$_GET['SetELDiBLehrer']."' ORDER BY `clienthistoryeldiblehrer`.`SaveTime` DESC";
      $sqldata = "SELECT * FROM `eldibdatadetailslehrer` LEFT JOIN  eldibdatalehrer ON eldibdatadetailslehrer.idData = eldibdatalehrer.idClient WHERE eldibdatalehrer.idClient = ".$_GET['SetELDiBLehrer']." AND  eldibdatadetailslehrer.idZiele = ".$zeile['id']." ";
